...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  <img class="w3-image" src="http://localhost/mhousing/assets/img/banner5.jpg" alt="London" width="1500" height="700">
  <div class="w3-display-middle" style="width:65%">
    ...
    <div id="login" class="w3-container  w3-opacity-min w3-white w3-padding-16 myLink">
      ...
      <a href="http://localhost/mhousing/register.php" target="_blank" class="w3-ripple w3-theme-d3 w3-right ">Register Account</a>
    </div>
